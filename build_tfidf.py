...
def count(ngram, hash_size, doc_id):
    ...
    counts = Counter(
            [retriever.utils.hash(gram, hash_size) for gram in ngrams]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--db-path', type=str, default='wikipedia/docs.db', #None
                        help='Path to sqlite db holding document texts')
    parser.add_argument('--out-dir', type=str, default='wikipedia/', #None
    ...
    parser.add_argument('--tokenizer', type=str, default='spacy', #'simple'
                        help=("String option specifying tokenizer type to use "
                              "(e.g. 'corenlp')"))
    parser.add_argument('--num-workers', type=int, default=12, #None
