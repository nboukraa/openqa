...
def add_model_args(parser):
    ...
    # Model architecture
    # -------------------------------------------------------------------------
    model = parser.add_argument_group('OpenQA Model Architecture')
    ...
    # Key model features
    # -------------------------------------------------------------------------
    features = parser.add_argument_group('OpenQA Model Features')
        
    features.add_argument('--concat-rnn-layers', type='bool', default=True,
                        help='Combine hidden states from each encoding layer')
    features.add_argument('--question-merge', type=str, default='self_attn',
                        help='The way of computing the question representation')
    features.add_argument('--use-qemb', type='bool', default=True,
                        help='Whether to use weighted question embeddings')
    features.add_argument('--use-in-question', type='bool', default=True,
                        help='Whether to use in_question_* features')
    # -------------------------------------------------------------------------
    # -------------------------------------------------------------------------
    features.add_argument('--use-pos', type='bool', default=False,
                        help='Whether to use pos features')
    features.add_argument('--use-ner', type='bool', default=False,
                        help='Whether to use ner features')
    features.add_argument('--use-lemma', type='bool', default=False, 
                        help='Whether to use lemma features')
    # -------------------------------------------------------------------------
    # -------------------------------------------------------------------------
    features.add_argument('--use-tf', type='bool', default=True,
                        help='Whether to use term frequency features')

    # -------------------------------------------------------------------------
    # Optimization details
    # -------------------------------------------------------------------------
    optim = parser.add_argument_group('OpenQA Optimization')
